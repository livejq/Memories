	...
	<div id="content-wrapper" class="container">
		...
		<article>
			<section><span style="font-size:1.6em;">您现在的位置:&nbsp;</span>
				<a href="ddstore.php">首页</a>&gt;&gt;<span style="font-size:1.4em;">关于我们<span>
			</section>
			<section id="video">
				<h2 id="title11">关于我们</h2>
				<section>
					<p>叮叮书店成立于2010年6月，是由教育部主管、清华大学主办的综合出版单位。植根于“清华”这座久负盛名的高等学府，秉承清华人“自强不息，厚德载物”的人文精神。</p>
					<div class="video">
						<video controls="controls" autoplay="autoplay" width="600px">
							<source src="images/book-store.mp4" type="video/mp4">
							<source src="images/book-store.webm" type="video/webm">
							<source src="images/book-store.ogg" type="video/ogg">
							<p>您的浏览器不支持video元素。</p>
						</video>
					</div>
				</section>
