	...
	<div id="content-wrapper" class="container">
		...
		<article>
			<section><span style="font-size:1.6em;">您现在的位置:&nbsp;</span>
				<a href="ddstore.php">首页</a>&gt;&gt;<span style="font-size:1.4em;">书籍分类<span>
			</section>
			<section class="piclist">
				<h2 id="title8">编程语言</h2>
				<ul>
					<li><a href="details.php"><img src="images/1.jpg" alt="无法加载"></a></li>
					<li><a href="details.php"><img src="images/2.jpg" alt="无法加载"></a></li>
					<li><a href="details.php"><img src="images/3.jpg" alt="无法加载"></a></li>
				</ul>
				<ul>
					<li><a href="details.php"><img src="images/4.jpg" alt="无法加载"></a></li>
					<li><a href="details.php"><img src="images/5.jpg" alt="无法加载"></a></li>
					<li><a href="details.php"><img src="images/6.jpg" alt="无法加载"></a></li>
				</ul>
				<div id="pagebar">
